...
#  define LV_MEM_SIZE    (8U * 1024U)  //// Increased to support fullscreen frame buffer
...
#define LV_FONT_MONTSERRAT_40    1 //// Previously 0
...
#define LV_THEME_DEFAULT_FONT_TITLE         &lv_font_montserrat_40 ////&lv_font_montserrat_14
